...
LRESULT CALLBACK WndProc(HWND hWnd, UINT iMessage, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
		...
		for (int i = 250; i < 450; i += 5)
		{
			Arc(hdc, 100 + i, 50, 200 + i, 250, 200 + i, 250, 150 + i, 50);   
		}
		for (int i = 250; i < 450; i += 2)
		{
			Arc(hdc, 100 + i, 50, 200 + i, 250, 200 + i, 250, 150 + i, 50);   
		}
		MoveToEx(hdc,109,212, NULL);
		LineTo(hdc, 112, 260);
		MoveToEx(hdc, 635, 215, NULL);
		LineTo(hdc, 637, 300);

		// ¿ÞÂÊ ±Í
		Arc(hdc, 60, 263, 110, 350, 110, 263, 110, 350);
		// 75 , 260 ,110, 330   90 300
		
		// ¿À¸¥ÂÊ ±Í
		// 636 279 690 360
		Arc(hdc, 636, 259, 690, 360, 620, 363, 636, 259);
